...
<head>
    ...
    <link rel="icon" href="https://maxcdn.icons8.com/Share/icon/Military//battleship1600.png">
...
<div id="wrap">
    <div align="center" class="text-center container" id="main" style="padding:50px 0;">
        <div class="logo">BattleShipGame Login</div>
        <!-- Main Form -->
...
<footer class="footer elegant-color-dark" id="footer">
    <div class="container">
        <div class="row">
            <div class="span12">
                <div class="col-xs-5">
                    <p class="text-muted">By Dan Ogen and Adi Madar 2017</p>
                </div>
            </div>
        </div>
    </div>
