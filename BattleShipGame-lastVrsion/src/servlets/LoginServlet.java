...
import Engine.BattleShipGame.RoomsManager;
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) {
            ...
            if (usernameFromParameter.isEmpty()) {
                ...
                if(Objects.equals(request.getParameter("loggedin"), "on") && roomsManager.isPlayerExists(usernameFromParameter)){
                    handleLoginAttributes(request, response, usernameFromParameter);   //case for the same user that wants to play from 2 browsers
                }
                    ...
                    roomsManager.addPlayer(usernameFromParameter);
                }
            }
        }
        else {
